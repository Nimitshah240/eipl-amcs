...
public class CDARptController implements MyInitialization {
    ...
    public void setupComboBox() {
        ...
        cboxType2.getItems().addAll("Date Wise", "Date & Shift Wise", "Dispatch Wise", "Dispatch Wise Format-2");
    ...
    private void validateAndGenerateReport() {
        ...
        } else if (cboxType2.getSelectionModel().getSelectedIndex() == 3) {
            if (cboxType1.getSelectionModel().getSelectedIndex() == 1) {
                JasperPrint print = ReportGenerate.getReportDataSourceJasperPrint(AppConstant.ReportPath.RtpMilkCollectionProfitloss2WithOutMilkType, params);
                JasperViewer.viewReport(print, false);
            } else {
                JasperPrint print = ReportGenerate.getReportDataSourceJasperPrint(AppConstant.ReportPath.RtpMilkCollectionProfitloss2, params);
                JasperViewer.viewReport(print, false);
            }
