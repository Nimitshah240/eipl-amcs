...
public class SchemeRateReportController implements MyInitialization {
    ...
    @FXML
    private ComboBox<Member> cboxMember, cboxMemberCode;
    @FXML
    ...
    /**
     * Method set data and action on btn close,generate.
     *
     * @param url
    ...
    /**
     * Method to get data of Shift,MilkType,Member,SocietyPaymentCycle from the backend.
     *
     * @author Nimit Shah
     * @createdOn 24-07-2025
     */
    ...
    /**
     * Method set data in the combobox.
     *
     * @author Nimit Shah
     * @createdOn 24-07-2025
     */
    ...
    /**
     * Method to generate 1st report (Society Purchase Scheme Rate Report )
     *
     * @author Nimit Shah
     * @createdOn 24-07-2025
     */
    private void validateAndGenerateReport() {
        try {
            ...
            JasperPrint print = ReportGenerate.getReportDataSourceJasperPrint(AppConstant.ReportPath.SCHEME_RATE_SOCIETY_PURCHASE_MEMBER_WISE, params);
    ...
    /**
     * Method to generate 2nd report (Society Purchase Member wise Scheme Rate Report )
     *
     * @author Nimit Shah
     * @createdOn 24-07-2025
     */
    ...
    /**
     * Method to generate 3rd report of all member(Member Milk Collection Slip Scheme Rate Report )
     *
     * @author Nimit Shah
     * @createdOn 24-07-2025
     */
    ...
    /**
     * Method to generate 3rd report of particular member(Member Milk Collection Slip Scheme Rate Report )
     *
     * @param code
     * @author Nimit Shah
     * @createdOn 24-07-2025
