...
public class ProductReceiptSaveTask extends Task<Object> {
    ...
    protected Object call() throws Exception {
        try {
            ...
            ResponseEntity<ProductReceiptDto> response = this.update == 0 ?
                    restTemplate.exchange(url, HttpMethod.POST, new HttpEntity<>(dto), ProductReceiptDto.class) :
                    restTemplate.exchange(url, HttpMethod.PUT, new HttpEntity<>(dto), ProductReceiptDto.class);
