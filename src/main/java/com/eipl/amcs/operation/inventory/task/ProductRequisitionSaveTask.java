...
public class ProductRequisitionSaveTask extends Task<Object> {
    ...
    protected Object call() throws Exception {
        try {
            ...
            ResponseEntity<ProductRequisitionDto> response = this.update == 0 ?
                    restTemplate.exchange(url, HttpMethod.POST, new HttpEntity<>(dto), ProductRequisitionDto.class) :
                    restTemplate.exchange(url, HttpMethod.PUT, new HttpEntity<>(dto), ProductRequisitionDto.class);
