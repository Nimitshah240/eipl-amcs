...
public class ShareTranferRevertTask extends Task<Boolean> {
    ...
    protected Boolean call() throws Exception {
        try {
            ...
            service.transferRevert(code, CommonUtil.setIdentityHeader());

//            RestTemplate restTemplate = EmcsAppContext.getContext().getBean(RestTemplate.class);
//            String url = MainApp.getProperty(AppConstant.Props.BASE_URL, null) + AppConstant.UrlPath.SHARE + "/transfer_revert/{code}";
