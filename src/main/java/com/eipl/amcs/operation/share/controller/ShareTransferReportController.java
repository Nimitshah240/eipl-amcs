...
public class ShareTransferReportController implements MyInitialization {
    ...
    private void validateAndGenerateReport() {
        ...
        print = ReportGenerate.getReportDataSourceJasperPrint(AppConstant.ReportPath.SHARE_TRANSFER, params);
