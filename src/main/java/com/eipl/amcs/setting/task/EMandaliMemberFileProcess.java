...
public class EMandaliMemberFileProcess extends Task<List<MemberDto>> {
    ...
    public EMandaliMemberFileProcess(Map<String, MilkType> milkTypeMap, Map<String, Gender> genderMap,
