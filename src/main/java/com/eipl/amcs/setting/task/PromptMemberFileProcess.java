...
public class PromptMemberFileProcess extends Task<List<MemberDto>> {
    ...
    public PromptMemberFileProcess(Map<String, MilkType> milkTypeMap, Map<String, Gender> genderMap,
