...
public class MemberDataMigrationController implements MyInitialization {
    ...
    public MemberDataMigrationController() {
    }
...
//    }
    ...
    private void startFileProcess() {
        ...
        var task = new PromptMemberFileProcess(mapMilkType, mapGender, memberType, txtFilePath.getText(),
    ...
    private void startAccessDbProcess() {
        lblStatus.setText("Preparing data...");
        var task = new PromptMemberDbProcess(mapMilkType, mapGender, memberType, txtFilePath.getText(),
                txtCow.getText(), txtBuffalo.getText());
        task.setOnSucceeded(e -> {
            lblStatus.setText("");
            try {
