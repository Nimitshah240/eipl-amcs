...
public class MilkCollectionDataMigrationFriendsController implements MyInitialization {
    @FXML
    StackPane root;
    @FXML
    ...
    private void startAccessDbProcess() {
        ...
        var task = new FriendsMilkCollectionDbProcess(selectedFilePath, dpFromDate.getValue(), dpToDate.getValue());
    ...
    private void startImportProcess() {
        var task = new FriendsMilkCollectionDbSaveTask(milkTypeList, shiftList, selectedFilePath,
