...
public class MemberDataMigrationFriendsController implements MyInitialization {
    @FXML
    ...
    public MemberDataMigrationFriendsController() {
    }
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        btnGenerate.setOnAction(e -> {
            ...
            if (txtFilePath.getText().endsWith(".txt"))
                startFileProcess();
            else if (txtFilePath.getText().endsWith(".mdb") || txtFilePath.getText().endsWith(".Mdb") || txtFilePath.getText().endsWith(".accdb"))
...
//    }
    ...
    private void startFileProcess() {
        ...
        var task = new FriendsMemberFileProcess(mapMilkType, mapGender, memberType, txtFilePath.getText(),
    ...
    private void startAccessDbProcess() {
        lblStatus.setText("Preparing data...");
        var task = new FriendsMemberDbProcess(mapMilkType, mapGender, memberType, txtFilePath.getText(),
                txtCow.getText(), txtBuffalo.getText());
        task.setOnSucceeded(e -> {
            lblStatus.setText("");
            try {
