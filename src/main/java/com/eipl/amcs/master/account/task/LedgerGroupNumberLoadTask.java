...
public class LedgerGroupNumberLoadTask extends Task<String> {
    private static final Logger LOGGER = LoggerFactory.getLogger(LedgerGroupNumberLoadTask.class);
    ...
    protected String call() throws Exception {
        try {
            ...
            String url = MainApp.getProperty(AppConstant.Props.BASE_URL, null) + AppConstant.UrlPath.LEDGER_GROUP+"/next-code";
            ...
            if (response == null || response.getStatusCode() != HttpStatus.OK)
                return null;
            LOGGER.info("Ledger Group fetched: {}", response.getBody());
