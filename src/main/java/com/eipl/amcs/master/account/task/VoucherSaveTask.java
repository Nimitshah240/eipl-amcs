...
public class VoucherSaveTask extends Task<Object> {

    private final VoucherDto dto;
    private final short update;

    public VoucherSaveTask(VoucherDto dto, short update) {
        this.dto = dto;
        this.update = update;
    }
...
//
//            ResponseEntity<VoucherDto> response = this.update == 0 ?
//                    restTemplate.exchange(url, HttpMethod.POST, new HttpEntity<>(dto), VoucherDto.class) :
//                    restTemplate.exchange(url, HttpMethod.PUT, new HttpEntity<>(dto), VoucherDto.class);
//
