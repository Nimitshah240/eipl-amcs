...
public class BillHeadAddEditController implements MyInitialization {
    ...
    public void loadBillHead() {
        try {
            ...
            cboxDisbursment.setValue(billHead.getDisburseAllowed() ? "YES" : "NO");
    ...
    private BillHead setValuesInObject() {
        try {
            ...
            String value = (String) cboxDisbursment.getValue();
            billHead.setDisburseAllowed("YES".equalsIgnoreCase(value) || "હા".equalsIgnoreCase(value));
