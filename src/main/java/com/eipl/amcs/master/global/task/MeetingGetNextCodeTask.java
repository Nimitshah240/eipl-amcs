...
public class MeetingGetNextCodeTask extends Task<String> {
    private static final Logger LOGGER = LoggerFactory.getLogger(MeetingGetNextCodeTask.class);

    public MeetingGetNextCodeTask() {
    }
    ...
    protected String call() throws Exception {
        try {
            ...
            if (response == null || response.getStatusCode() != HttpStatus.OK)
                return null;
            LOGGER.info("meeting No fetched: {}", response.getBody());
            return response.getBody();
        } catch (Exception e) {
            LOGGER.error("meeting No fetch", e);
        }
        return null;
    }
