...
public class InsuranceDetailAudit extends BaseModelAudit {
    private Integer id;
    private Integer insuranceDetailCode;
    ...
    public Integer getInsuranceDetailCode() {
        return insuranceDetailCode;
    }

    public void setInsuranceDetailCode(Integer insuranceDetailCode) {
        this.insuranceDetailCode = insuranceDetailCode;
    }
    ...
    public void setNomineeAdharNo(String nomineeAdharNo) {
        this.nomineeAdharNo = nomineeAdharNo;
    }
